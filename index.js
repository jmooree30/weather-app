...
fetch(
  ...
  .then(function(response) {
    ...
    let iconThreeUrl = "http://openweathermap.org/img/w/" + iconThreeCode + ".png";
    ...
    let iconFourUrl = "http://openweathermap.org/img/w/" + iconFourCode + ".png";
    ...
    let iconFiveUrl = "http://openweathermap.org/img/w/" + iconFiveCode + ".png";
