...
function weather() {
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?zip=${city},us&units=imperial&APPID=38c7a3bf4046499d8be4a15128e0d64a`,
    { mode: "cors" }
  )
  ...
  // 5 day forcast
  fetch(
    `https://api.openweathermap.org/data/2.5/forecast?zip=${city},us&units=imperial&APPID=38c7a3bf4046499d8be4a15128e0d64a`,
    { mode: "cors" }
  )
    .then(function(response) {
      return response.json();
